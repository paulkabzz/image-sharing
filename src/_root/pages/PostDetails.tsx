      ...
      {isLoading || !post ? (
        ...
        <div className="post_details-card">
          ...
          <div className="post_details-info">
              ...
              <Link
                ...
                <div className="flex gap-1 flex-col">
                  ...
                  <div className="flex-center gap-2 text-light-3 ">
                    <p className="subtle-semibold lg:small-regular whitespace-nowrap overflow-ellipsis">
            ...
            <div className="flex flex-col flex-1 w-full small-medium lg:base-regular !text-[12px] !text-[#131313]">
              <p>{post?.caption}</p>
