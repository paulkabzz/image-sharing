...
export const SignupValidation = z.object({
    name: z.string()
        ...
        .regex(namePattern, { message: "Name can only contain letters, numbers, periods, and underscores, with no consecutive periods and not starting or ending with a period." }),
